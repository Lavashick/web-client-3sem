<template>
  <div>
    ...
    <img class="mt-2 character-img" :src="character.image" width="300px" alt="" />
...
//   props: ["id", "character"],
  ...
  async created() {
    ...
    try {
      const res = await axios.get("https://rickandmortyapi.com/api/character/" + this.$route.params.id);
